export const largeCardSections = [
  {
    id: 1,
    title: 'Top-rated Cars in Sri Lanka',
    snippet: 'Our Buyers say these are the best Cars in the Island.',
    cards: [
      {
        id: 19,
      ...
      },
      {
        ...
        snippet: 'This is one of the most red fire extinguishers you will ever see. Super clean. Its pretty much useless otherwise.',
        image: 'fe2.jpg'
      },
      {
        id: 21,
  ...
  {
    id: 2,
    title: 'Luxury Super Cars',
    snippet: 'Make Your Life Super Easy with those beasts!',
    cards: [
      {
        id: 22,
        title: 'Vintage 1864 Fire Extinguisher',
        snippet: 'This is hands down the worst fire extinguisher you can use in a crisis. The radiation will kill you if the fire doesnt',
        image: 'fe4.png'
      },
      {
        id: 23,
      ...
      },
      {
        ...
        snippet: 'This is the first ever two in one fire extinguisher. Good if both you and your friends houses are burining down',
        image: 'fe6.jpg'
      }
    ]
  }
